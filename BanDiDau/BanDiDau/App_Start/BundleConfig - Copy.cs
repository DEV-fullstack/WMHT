        ...
        public static void RegisterBundles(BundleCollection bundles)
        {
            ...
            bundles.Add(new StyleBundle("~/Content/css").Include(
                      ...
                      "~/Content/bandidau.css",
                        ...
                        //jplist
                      "~/Content/jPlist/css/jplist.core.min.css",
                      "~/Content/jPlist/css/jplist.core.min.css",
                      "~/Content/jPlist/css/jplist.checkbox-dropdown.min.css",
                      "~/Content/jPlist/css/jplist.pagination-bundle.min.css",
                       "~/Content/jPlist/css/jplist.textbox-filter.min.css",
